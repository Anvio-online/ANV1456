...
faq:
  - question: 'How much does an AI chatbot cost for a small business?'
    answer: 'Typically ₹30,000–₹90,000 to build, depending mainly on how much documentation there is to structure and how many distinct topics it needs to handle — not on how many conversations it has once live. Ongoing model API costs are usage-based and small at most business volumes.'
...
relatedLinks:
  - label: 'AI agent development'
    ...
    note: 'For work that takes action, not just answers a question.'
...
It doesn't act — it answers. If a customer needs their order updated, a record changed, or a multi-step process carried out, that's a different job: [AI agent development](/services/automate/ai-agent-development). Building a chatbot to attempt actions it wasn't designed for is the most common way these projects go wrong, and it's also the boundary we hold most carefully in scoping any chatbot engagement.
