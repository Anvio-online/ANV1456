...
faq:
  ...
  - question: 'What does it cost and how long does it take?'
    answer: 'For a business processing a moderate monthly invoice volume, a build in the ₹30,000–₹90,000 range is typical, with 2–4 weeks to a first working version. The real cost driver is the variety of vendor formats and document quality, not the invoice count.'
relatedLinks:
...
**What does it cost and how long does it take?** For a business processing a moderate monthly invoice volume, a build in the ₹30,000–₹90,000 range is typical, with 2–4 weeks to a first working version. The real cost driver is the variety of vendor formats and document quality, not the invoice count.
