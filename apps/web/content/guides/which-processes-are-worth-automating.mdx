...
relatedLinks:
  ...
  - label: 'How to automate lead follow-ups'
    href: '/guides/how-to-automate-lead-follow-ups'
    note: 'A worked example of the framework applied to one of the most common candidates.'
---
