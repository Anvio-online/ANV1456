 ...
 *
 * Only 'centered-statement' is built (Home's hero). split-visual,
 * page-lead, and case-lead are documented in section-library.md §3
 * but not yet scaffolded — add them the same way when a page needs one.
 */
