...
- [ ] **Read the Stratseek agreement** — **narrower than this plan assumed.** It covers BluPebble, which did come through the agency. It does *not* cover Baladi and Epicerma: those were direct freelance clients all along, and this plan's §1a was wrong to file them behind it ([projects-spec.md](projects-spec.md), correction dated 2026-08-10). `/case-studies` is therefore blocked on asking two clients directly for permission — an email each — not on a contract review.
